        ...
        if (machineState !== MachineState.PLAYING_SESSION && machineState !== MachineState.GENERATING_SCRIPT) {
            setAgents(prev => {
                ...
                const next = prev.map(a => {
                    ...
                    // Optimization: Flag that an actual decay happened
                    hasChanges = true;
                ...
                // Optimization: Return the original reference if no changes occurred to prevent re-renders and localStorage writes
