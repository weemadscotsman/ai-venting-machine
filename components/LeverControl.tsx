    ...
    <div className="flex gap-4 w-full h-full items-end">
      ...
      <div className="flex flex-col gap-1 items-center justify-end h-full pb-1">
        ...
        <button
          ...
          className={`
            w-16 h-8 rounded-full border-2 relative transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505]
      ...
      <div className="relative group flex-1 h-24">
        ...
        <button
          ...
          className={`
            ...
            shadow-[0_0_20px_rgba(0,0,0,0.5)] z-10 overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505]
            ${disabled || isAutoMode
      ...
      <div className="relative w-32 h-24">
         <button
            ...
            className={`
              ...
              border-4 transition-all duration-100 flex flex-col items-center justify-center gap-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#050505]
