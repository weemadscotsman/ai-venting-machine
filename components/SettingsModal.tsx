        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md">
            <div className="w-full max-w-lg bg-[#0a0a0a] border border-gray-700 p-6 rounded shadow-[0_0_50px_rgba(0,255,255,0.1)] relative">
                <div className="flex justify-between items-center mb-6 border-b border-gray-800 pb-2">
                    ...
                    <button onClick={onClose} aria-label="Close settings" className="text-gray-500 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 rounded px-1">
